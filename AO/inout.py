...
def compute_parent(dataset):
    ...
    layerList1 = [
        Convolutional(filters=320, filter_size=17, stride_size=1, padding='same',
                      input_shape=dataset['x_train'].shape[0:]),
        Convolutional(filters=320, filter_size=17, stride_size=1, padding='valid',
                      input_shape=dataset['x_train'].shape[0:])
    ]
    layerList2 = [
    ...
    '''
    layerList1 = [
        FullyConnected(units=512, num_classes=dataset['num_classes'])
    ]
    layerList2 = []
